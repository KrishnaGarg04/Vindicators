...
f = open('variablenames.csv', 'r')   # taking value of variables stored in csv file
fread = csv.reader(f)
for row in fread:
...
f = open('instructions.txt', 'w')  #saving parking lane in text file
...
f = open("variablenames.csv", 'w', newline = '')
